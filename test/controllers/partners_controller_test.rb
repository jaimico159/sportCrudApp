...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { code: @partner.code, name: @partner.name, record_status: @partner.record_status } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { code: @partner.code, name: @partner.name, record_status: @partner.record_status } }
